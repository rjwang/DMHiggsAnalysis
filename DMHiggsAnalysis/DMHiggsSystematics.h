#ifndef DMHiggsSystematics_DMHiggsSystematics_H
#define DMHiggsSystematics_DMHiggsSystematics_H
...
class DMHiggsSystematics : public HgammaAnalysis {
...
public:
    ...
    DMHiggsSystematics() { }
    DMHiggsSystematics(const char *name);
    virtual ~DMHiggsSystematics();
    ...
    ClassDef(DMHiggsSystematics, 1);
};

#endif // DMHiggsSystematics_DMHiggsSystematics_H
